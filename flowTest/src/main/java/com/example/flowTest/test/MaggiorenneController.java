...
@Component("maggiorenneController")
public class MaggiorenneController extends BaseBlockController<EndControllerE> {
	...
	public EndControllerE execute(Request request, Response response) {		
		...
		stringResponse.getResponse().append("Eseguo Maggiorenne Controller, ");		
