...
@Component("minorenneController")
public class MinorenneController extends BaseBlockController<EndControllerE> {
	...
	public EndControllerE execute(Request request, Response response) {		
		...
		stringResponse.getResponse().append("Eseguo Minorenne Controller, ");		
